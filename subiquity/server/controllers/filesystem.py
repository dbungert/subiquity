    ...
    async def run_autoinstall_guided(self, layout):
        ...
        if name == "hybrid":
            ...
            if encrypted is None:
                if (
                    GC.CORE_BOOT_ENCRYPTED in self._info.capabilities
                    or GC.CORE_BOOT_PREFER_ENCRYPTED in self._info.capabilities
                ):
                ...
                if (
                    self._info.capabilities == {GuidedCapability.CORE_BOOT_ENCRYPTED}
                    and not encrypted
                ):
